...
Referance.ctrl = {
    ...
    addContent: function () {
        ...
        //获取html中已有数目的条数
        var total = $('.resultItem').length;
        var index = total + 1;

        html = '<div class="resultItem"><div class="referanceContent">['+index+'] ' + result + '</div><a href="javascript:" class="delete">删除</a><a href="javascript:" class="edit">编辑</a></div>';
